...
export class FileService {
  ...
  public localUrl = 'http://192.168.0.149:8082';
  // public localUrl = 'http://action.hxig.cn';
  constructor(private camera: Camera, private toastCtrl: ToastController, private loadingCtrl: LoadingController) {
  }
  /**
  /**
   * 统一调用此方法显示提示信息
   ...
   */
  showTabs(){
    let doc = document.getElementById('buttomTabs');
    let elements = doc.querySelectorAll(".tabbar");
    if (elements != null) {
