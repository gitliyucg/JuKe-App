...
/**
 * Generated class for the StockchangelistPage page.
 *
 * See http://ionicframework.com/docs/components/#navigation for more info
 * on Ionic pages and navigation.
 */
@Component({
  selector: 'page-stockchangelist',
  templateUrl: 'stockchangelist.html',
})
export class StockchangelistPage {
  ...
  ionViewDidLoad() {
    ...
    this.storage.get('userStorage').then(value => {
      ...
      this.file.loading.present().then(() => {
        this.http.get(this.file.localUrl + '/action/GuQuan/GetDuihuanList/' + this.UID + '?num=' + this.Pagenum).toPromise().then(response => {
